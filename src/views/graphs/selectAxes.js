...
const SelectAxes = ({
  ...
  const listItemsX = columns.filter(col => typeof data[0][col] === "number").map((col, index) => 
  ...
  addYAxis(10);
    ...
    return (
      <div>
        ...
        <strong> <font face="helvetica"> &nbsp; Variable quantitative : &nbsp; </font> </strong>
        ...
        <strong> <font face="helvetica"> &nbsp; Nombre de classes : &nbsp; </font> </strong>
